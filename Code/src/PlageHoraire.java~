...
public class PlageHoraire {
	...
	PlageHoraire(int _idPlage, GregorianCalendar _dateDebut, GregorianCalendar _dateFin, String _memo, int _idSalle, int _idGroupe, int _idMatiere, int _idProf, boolean _internet, int _idProfQuiFaitAppel) {
		idPlage=_idPlage;
	...
	PlageHoraire(int _idPlage, GregorianCalendar _dateDebut, GregorianCalendar _dateFin, String _memo, int _idSalle, int _idGroupe, int _idMatiere, int _idProf, boolean _internet, boolean _controle, int _idSalle2, int _idProf2, int _idProf3, int _idProf4, int _idProfQuiFaitAppel) {
		idPlage=_idPlage;
		dateDebut = _dateDebut;
		dateFin = _dateFin;
        if (_memo==null) memo="";
