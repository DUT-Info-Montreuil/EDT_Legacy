...
/*public class FenetreLogin extends JFrame implements ActionListener {
    ...
    public FenetreLogin_wt(EDTApplication_wt _edtAppli) {
        ...
        nomBaseDeDonnee = new WInPlaceEdit("database.iut.univ-paris8.fr/adminedt-test"); // ent-test.iut.univ-paris8.fr/
    ...
    public boolean verifNomPassword() {        	
            ...
            //}            
            try {
                //Utilitaire.showMessageDialog(this,"Test 1, nom = : "+nomUtilisateur.getText() );
    ...
    public Connection connecter() {
        ...
        try {
            ...
            db = DriverManager.getConnection(
                 //   "jdbc:" + nomBaseDeDonnee.getText(), //debug : 12/02/2019 
    ...
    public void validation() {
    	if (verifNomPassword()==true) {
						...
						VueEDT_wt vueEDT_wt=new VueEDT_wt(edtAppli);//VueEDT_wt
						...
						vueEDT_wt.mouseWentOver().addListener(vueEDT_wt,new Signal1.Listener<WMouseEvent>(){//ajouté le 15 mai 2019
								public void trigger(WMouseEvent evt){
									System.out.println("mouse wentOver");
									controleurGUI.mouseEntered(evt);	
								}
						});*/
